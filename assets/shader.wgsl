...
@group(0) @binding(0)
var<storage, read> chunkData : array<array<i32, 3>>;
...
fn create_translation_matrix(translation: array<i32, 3>) -> mat4x4<f32> {
    return mat4x4<f32>(
        vec4<f32>(1.0, 0.0, 0.0, 0.0),  // First column
        vec4<f32>(0.0, 1.0, 0.0, 0.0),  // Second column
        vec4<f32>(0.0, 0.0, 1.0, 0.0),  // Third column
        vec4<f32>(f32(translation[0]), f32(translation[1]), f32(translation[2]), 1.0) // Fourth column
    );
}
